...
<main id="main">
    <section class="page-hero">
      <div class="hero-media" data-parallax="0.12">
        <img src="<?php echo esc_url( get_template_directory_uri() . '/images/villa-palms.jpg' ); ?>" alt="June Henry Homes residences seen from the garden" fetchpriority="high">
      </div>
      ...
      <div class="container split">
        <div class="split-media">
          <div class="media-stack">
            <div class="media media-main reveal-mask"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/living-pool-view.jpg' ); ?>" alt="Open living room inside a June Henry Homes residence" loading="lazy"></div>
        ...
        <div class="split-body">
          <span class="eyebrow reveal">Our vision</span>
    ...
    <!-- Stats -->
    <section class="section-tight" style="padding-top:0" aria-label="June Henry Homes at a glance">
      <div class="container stats">
        <div class="stat reveal"><div class="stat-num">1<small>+</small></div><div class="stat-label">Month minimum stay</div></div>
        <div class="stat reveal" style="--d:.08s"><div class="stat-num">6–8</div><div class="stat-label">Guests per home</div></div>
        <div class="stat reveal" style="--d:.16s"><div class="stat-num"><span data-count="5">5</span></div><div class="stat-label">Dedicated staff roles</div></div>
        <div class="stat reveal" style="--d:.24s"><div class="stat-num"><span data-count="3">3</span></div><div class="stat-label">Daily meals, plus snacks</div></div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <div class="section-head">
          <span class="eyebrow center reveal">Who we welcome</span>
          <h2 class="h2" data-split>A season designed around <span class="script">you</span>.</h2>
          <p class="lead reveal">For active adults, and for the families who want the very best for them.</p>
        </div>
        <div class="card-grid">
          <article class="info-card reveal" data-glow>
            <span class="icon-ring"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" aria-hidden="true"><path d="M12 2v20M4.2 7l15.6 10M4.2 17L19.8 7M9 4l3 2 3-2M9 20l3-2 3 2"/></svg></span>
            <h3>Escaping winter</h3>
            <p>Trade cold months for sunshine, fresh Caribbean meals, and evenings watching the sunset in St. Ann.</p>
          </article>
          <article class="info-card is-navy reveal" style="--d:.1s" data-glow>
            ...
            <p>Step away from everyday responsibilities for a month or more, with everything thoughtfully taken care of.</p>
          </article>
          <article class="info-card reveal" style="--d:.2s" data-glow>
            <span class="icon-ring"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" aria-hidden="true"><path d="M3 20h18M6 20v-5l6-5 6 5v5"/><circle cx="12" cy="5" r="2"/></svg></span>
            <h3>A more effortless way to live</h3>
            <p>Leave the worries of home maintenance behind and simply enjoy your days surrounded by comfort, beauty, and genuine care.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="section" style="padding-top:0">
      <div class="container split reverse">
        <div class="split-media">
          <div class="media reveal-mask"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/dining-room.jpg' ); ?>" alt="The chef serving guests at the table" loading="lazy"></div>
        </div>
        <div class="split-body">
          <span class="eyebrow reveal">Everything taken care of</span>
          <h2 class="h2" data-split>Your stay includes</h2>
    ...
    <!-- The June Henry difference, merged in from its own page -->
    <section class="section" id="difference" aria-labelledby="difference-title">
      <div class="container">
        <div class="section-head left">
          <span class="eyebrow reveal">The June Henry difference</span>
          <h2 id="difference-title" class="h2" data-split>Not a vacation. Not assisted living. A better way to live through <span class="script">winter</span>.</h2>
        </div>
        <div class="feature-rows">
          <div class="feature-row reveal">
            <span class="feature-num" aria-hidden="true">01</span>
            <h3>One Month or Longer</h3>
            <p>A true seasonal home—not a short-term holiday. Settle into Jamaica at your own pace.</p>
          </div>
          <div class="feature-row reveal">
            <span class="feature-num" aria-hidden="true">02</span>
            <h3>Everything Taken Care Of</h3>
            <p>Chef-prepared meals, housekeeping, laundry, gardening, transportation, and concierge support—so everyday responsibilities don’t follow you to Jamaica.</p>
          </div>
          <div class="feature-row reveal">
            <span class="feature-num" aria-hidden="true">03</span>
            <h3>Luxury That Feels Like Home</h3>
            <p>Private residential living with the warmth, familiarity, and freedom of home—not the feeling of being in a hotel or facility.</p>
          </div>
          <div class="feature-row reveal">
            <span class="feature-num" aria-hidden="true">04</span>
            <h3>Care Without Losing Independence</h3>
            <p>Thoughtful, light support when you need it, while preserving your freedom, privacy, and choice.</p>
          </div>
          <div class="feature-row reveal">
            <span class="feature-num" aria-hidden="true">05</span>
            <h3>A Home Where People Know You</h3>
            <p>With only <strong>6–8 guests per home</strong>, the experience is intentionally intimate. You’re not one of hundreds of guests—you become part of a community.</p>
          </div>
          <div class="feature-row reveal">
            <span class="feature-num" aria-hidden="true">06</span>
            <h3>Designed Around Your Winter, Not a Program</h3>
            <p>No rigid schedule or institutional routine. Your days can be as active, peaceful, social, or private as you want them to be.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <div class="section-head">
          <span class="eyebrow center reveal">Continue exploring</span>
        ...
        <div class="collection-nav">
          ...
          <a class="collection-link reveal" style="--d:.1s" href="<?php echo esc_url( home_url( '/beyond-the-stay/' ) ); ?>">
            <img src="<?php echo esc_url( get_template_directory_uri() . '/images/courtyard-homes.jpg' ); ?>" alt="" loading="lazy">
